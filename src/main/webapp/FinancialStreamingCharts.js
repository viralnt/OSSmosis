...
var finD3App = angular.module('finD3App', []);

// controller business logic
finD3App.controller('AppCtrl', function AppCtrl ($scope, $http) {
  ...
  /**
   * Helper functions start here - 2 of them right now
   */
  ...
  $scope.fetchDataAndDrawLineChart = function () {
  ...
  $scope.fetchDataAndDrawLineChart();
  
 });


finD3App.directive('finvisualization', function () {
  ...
  return {
    ...
    link: function (scope, element, attrs) {
    		...
    		scope.$watch('findata', function (newVal, oldVal) {
